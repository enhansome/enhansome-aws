...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 504,160 | 🐛 106 | 📅 2026-09-02 list.
...
* [Repo :fire::fire::fire::fire:](https://github.com/awslabs/aws-sdk-cpp) ⭐ 2,209 | 🐛 105 | 🌐 C++ | 📅 2026-09-08
...
* [aws/aws-amplify :fire::fire::fire::fire::fire:](https://github.com/aws/aws-amplify) ⭐ 9,559 | 🐛 511 | 🌐 TypeScript | 📅 2026-09-08
...
* [Repo :fire::fire::fire::fire::fire:](https://github.com/boto/boto3) ⭐ 9,898 | 🐛 192 | 🌐 Python | 📅 2026-09-07
...
* [boto3 :fire::fire::fire::fire::fire:](https://github.com/boto/boto3) ⭐ 9,898 | 🐛 192 | 🌐 Python | 📅 2026-09-07
* [botocore :fire::fire::fire::fire:](https://github.com/boto/botocore) ⭐ 1,644 | 🐛 195 | 🌐 Python | 📅 2026-09-07

### Ruby SDK

* [Samples :fire::fire::fire::fire::fire:](https://github.com/awsdocs/aws-doc-sdk-examples/tree/master/ruby/example_code/) ⭐ 10,460 | 🐛 149 | 🌐 Java | 📅 2026-09-03
* [Repo :fire::fire::fire::fire::fire:](https://github.com/aws/aws-sdk-ruby) ⭐ 3,656 | 🐛 26 | 🌐 Ruby | 📅 2026-09-07
...
* [Repo :fire::fire::fire::fire:](https://github.com/aws/aws-sdk-net) ⭐ 139 | 🐛 34 | 🌐 C# | 📅 2026-09-04
...
* [Repo :fire::fire::fire::fire::fire:](https://github.com/aws/aws-cli) ⭐ 17,240 | 🐛 731 | 🌐 Python | 📅 2026-09-08
...
* [aws-cli :fire::fire::fire::fire::fire:](https://github.com/aws/aws-cli) ⭐ 17,240 | 🐛 731 | 🌐 Python | 📅 2026-09-08 - Universal Command Line Interface.
...
* [aws-cdk :fire::fire::fire::fire::fire:](https://github.com/aws/aws-cdk) ⭐ 12,889 | 🐛 2,865 | 🌐 TypeScript | 📅 2026-09-08 - Framework for defining cloud infrastructure in code.
...
* [cfncluster :fire::fire::fire:](https://github.com/awslabs/cfncluster) ⭐ 889 | 🐛 175 | 🌐 Python | 📅 2026-09-08 - Framework that deploys and maintains HPC clusters.
* [cfncluster-cookbook](https://github.com/awslabs/cfncluster-cookbook) ⭐ 116 | 🐛 23 | 🌐 Ruby | 📅 2026-09-08 - Sample Cookbook.
...
* [aws-codedeploy-agent :fire::fire:](https://github.com/aws/aws-codedeploy-agent) ⭐ 337 | 🐛 80 | 🌐 Rust | 📅 2026-09-08 - Sample agent.
...
* [kelseyhightower/kubernetes-the-hard-way :fire::fire::fire::fire::fire:](https://github.com/kelseyhightower/kubernetes-the-hard-way) ⭐ 49,684 | 🐛 54 | 📅 2025-04-10 - Bootstrap Kubernetes the hard way on EC2. No scripts.
* [openebs/openebs :fire::fire::fire::fire::fire:](https://github.com/openebs/openebs) ⭐ 9,808 | 🐛 35 | 📅 2026-09-08 - Containerized block storage QoS SLAs, tiering and replica policies across AZs and environments, and predictable and scalable performance.
...
* [amazon-ecs-agent :fire::fire::fire::fire:](https://github.com/aws/amazon-ecs-agent) ⭐ 2,178 | 🐛 28 | 🌐 Go | 📅 2026-09-07 - Agent that runs on and starts containers.
...
* [amazon-kinesis-client :fire::fire::fire:](https://github.com/awslabs/amazon-kinesis-client) ⭐ 667 | 🐛 337 | 🌐 Java | 📅 2026-09-07 Client library for Amazon Kinesis.
...
* [awslabs/aws-sam-local :fire::fire::fire::fire::fire:](https://github.com/awslabs/aws-sam-local) ⭐ 6,732 | 🐛 529 | 🌐 Python | 📅 2026-09-08 - CLI tool for local development and testing of Serverless applications.
...
* [serverless/serverless :fire::fire::fire::fire::fire:](https://github.com/serverless/serverless) ⭐ 46,916 | 🐛 1,218 | 🌐 JavaScript | 📅 2026-09-07 The Serverless Application Framework (formerly JAWS).
...
* [Miserlou/Zappa :fire::fire::fire::fire::fire:](https://github.com/Miserlou/Zappa) ⭐ 11,818 | 🐛 687 | 🌐 Python | 📅 2023-03-23 - Serverless WSGI Python Web Apps with AWS Lambda + API Gateway.
...
* [claudiajs/claudia :fire::fire::fire::fire::fire:](https://github.com/claudiajs/claudia) ⭐ 3,884 | 🐛 27 | 🌐 JavaScript | 📅 2026-05-03 - Deploy Node.js projects to Lambda and API Gateway easily.
...
* [getredash/redash :fire::fire::fire::fire::fire:](https://github.com/getredash/redash/) ⭐ 28,783 | 🐛 803 | 🌐 Python | 📅 2026-09-03 - A web application that allows to easily query an existing database, share the dataset and visualize it in different ways. Initially was developed to work with Redshift, and has great support for it.
...
* [ncw/rclone :fire::fire::fire::fire::fire:](https://github.com/ncw/rclone) ⭐ 59,647 | 🐛 1,267 | 🌐 Go | 📅 2026-09-08 - Rsync for various cloud storage providers such as S3.
* [mickael-kerjean/filestash :fire::fire::fire::fire::fire:](https://github.com/mickael-kerjean/filestash) ⭐ 14,633 | 🐛 123 | 🌐 Go | 📅 2026-09-08 - A modern web client for S3.
* [s3fs-fuse/s3fs-fuse :fire::fire::fire::fire::fire:](https://github.com/s3fs-fuse/s3fs-fuse) ⭐ 9,984 | 🐛 314 | 🌐 C++ | 📅 2026-09-08 - Allows Linux and Mac OS X to mount an S3 bucket via FUSE.
...
* [peak/s5cmd :fire::fire::fire:](https://github.com/peak/s5cmd) ⭐ 4,185 | 🐛 192 | 🌐 Go | 📅 2025-06-13 - Fast S3 and local filesystem execution tool with wildcard and batch command support.
...
* [aws-data-wrangler :fire::fire::fire::fire::fire:](https://github.com/awslabs/aws-data-wrangler) ⭐ 4,120 | 🐛 54 | 🌐 Python | 📅 2026-09-08 - Connects Pandas DataFrames and AWS data related services.
...
* [cloud-custodian/cloud-custodian :fire::fire::fire::fire::fire:](https://github.com/cloud-custodian/cloud-custodian) ⭐ 6,062 | 🐛 1,738 | 🌐 Python | 📅 2026-09-08 - Rules engine for management, DSL in yaml for query, filter, and actions on resources.
...
* [s2n :fire::fire::fire::fire::fire:](https://github.com/awslabs/s2n) ⭐ 4,761 | 🐛 318 | 🌐 C | 📅 2026-09-08 - An implementation of the TLS/SSL protocols.
...
* [trailofbits/algo :fire::fire::fire::fire::fire:](https://github.com/trailofbits/algo) ⭐ 30,368 | 🐛 77 | 🌐 Python | 📅 2026-09-02 - Set up a personal IPSEC VPN on EC2 and other cloud services.
* [bridgecrewio/checkov :fire::fire::fire::fire::fire:](https://github.com/bridgecrewio/checkov) ⭐ 8,988 | 🐛 162 | 🌐 Python | 📅 2026-09-05 - Terraform static analysis, verifies security best practices.
...
* [Netflix/chaosmonkey :fire::fire::fire::fire::fire:](https://github.com/Netflix/chaosmonkey) ⭐ 17,102 | 🐛 34 | 🌐 Go | 📅 2025-01-06 - Resiliency tool that helps applications tolerate random instance failures.
* [Netflix/zuul :fire::fire::fire::fire::fire:](https://github.com/Netflix/zuul) ⭐ 14,071 | 🐛 16 | 🌐 Java | 📅 2026-09-02 - Edge service that provides dynamic routing, monitoring, resiliency, security, and more.
* [Netflix/eureka :fire::fire::fire::fire::fire:](https://github.com/Netflix/eureka) ⭐ 12,739 | 🐛 139 | 🌐 Java | 📅 2026-08-24 - Service registry for resilient mid-tier load balancing and failover.
* [Spinnaker/spinnaker :fire::fire::fire::fire::fire:](https://github.com/Spinnaker/spinnaker) ⭐ 9,783 | 🐛 103 | 🌐 Java | 📅 2026-09-08 - Successor to asgard supporting pipelines and more.
* [spulec/moto :fire::fire::fire::fire::fire:](https://github.com/spulec/moto) ⭐ 8,652 | 🐛 72 | 🌐 Python | 📅 2026-09-07 - Allows your python tests to easily mock out the boto library.
...
* [Open Guide to AWS :fire::fire::fire::fire::fire:](https://github.com/open-guides/og-aws) ⭐ 36,452 | 🐛 159 | 🌐 Shell | 📅 2024-08-16
...
* [A Curated List of Engineering Blogs](https://github.com/kilimchoi/engineering-blogs) ⭐ 38,586 | 🐛 151 | 🌐 Ruby | 📅 2024-08-21
...
Other awesome lists can be found in [awesome](https://github.com/sindresorhus/awesome) ⭐ 504,160 | 🐛 106 | 📅 2026-09-02 and [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,660 | 🐛 63 | 🌐 Ruby | 📅 2024-06-02.
